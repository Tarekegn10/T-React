...
INSERT INTO users (username, email, password_hash, name, phone, position, role, status) VALUES
    ('admin', 'admin@company.com', '$2b$10$rQZ9QH5pCFEjKy5F5oqWxOxnXhWVnMxSz3kJZlN5DXPS5WYvLF.Gy', 'Administrator', '+1 234 567 8900', 'System Administrator', 'admin', 'active');

-- Insert default user (password: user123)
INSERT INTO users (username, email, password_hash, name, phone, position, department_id, role, status) VALUES
    ('user', 'user@company.com', '$2b$10$YXNhZGFzZGFzZGFzZGFzZO5QxM5WYvLF.GyexamplehashZlN5DXPS', 'Jane Smith', '+1 234 567 8901', 'Secretary', (SELECT id FROM departments WHERE name = 'Executive'), 'user', 'active');
